...
namespace RotationTutorial
{
    public class SettingsState:IGame
    {
        ...
        public SettingsState(GraphicsDeviceManager graphics)
        {
            ...
            list=new string[]{"1280:800","640:480"}.ToList<string>();
            resolutionButton = new SettingsButtons(list, new Rectangle(100, 300, 250, 250));
            ...
            fullscreen = new SettingsButtons(list,new Rectangle(100,400,250,250));
